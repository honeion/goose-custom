...
#[openapi(
    paths(
        ...
        // local_inference routes disabled for Windows build (llama-cpp-2 C++ runtime conflict)
    ...
    components(schemas(
        ...
        // local_inference schemas disabled for Windows build (llama-cpp-2 C++ runtime conflict)
